...
const question3AProceedBackButton = document.getElementById('question3AProceedBackButton');
...
question3AProceedOptionA.addEventListener('click', function(e) {
    ...
    question3AProceedBackButton.classList.remove('active');
...
// 问题3A后续新弹窗返回按钮点击事件处理
question3AProceedBackButton.addEventListener('click', function(e) {
    e.stopPropagation(); // 阻止事件冒泡
    console.log('点击了返回按钮');
    // 隐藏当前弹窗
    question3AProceedModal.classList.remove('active');
...
fakeEnding2BackButton.addEventListener('click', function(e) {
    ...
    if (question3AProceedBackButton) question3AProceedBackButton.classList.remove('active');
                    ...
                    if (collectedSpots === maxSpots) {
                        setTimeout(() => {
                            ...
                            // 检查是否是问题3A后续游戏模式
                                ...
                                question3AProceedBackButton.classList.add('active');
                            } 
